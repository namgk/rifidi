...
/**
 * Factory class for the Snail reader.  
 * 
 * @author Matthew Dean - matt@pramari.com
 */
public class SnailSensorFactory extends AbstractSensorFactory<SnailSensor> {

	/** The Unique FACTORY_ID for this Factory */
	public static final String FACTORY_ID = "Snail";
	/** Description of the sensorSession. */
	private static final String description = "A snail Rifidi Adapter.  ";
	...
	public void createInstance(String serviceID)
		...
		SnailSensor instance = new SnailSensor(commands);
	...
	public MBeanInfo getServiceDescription(String factoryID) {
		return (MBeanInfo)SnailSensor.mbeaninfo;
	}
