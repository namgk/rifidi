...
import org.fosstrak.ale.xsd.ale.epcglobal.CCParameterList.Entries;


/**
 * <p>Java class for CCParameterList complex type.
 * 
...
@XmlType(name = "CCParameterList", propOrder = {
    "entries"
})
public class CCParameterList {
    ...
    public static class Entries {
        ...
        protected List<CCParameterListEntry> entry;
         ...
         * {@link CCParameterListEntry }
         * 
         * 
         */
        public List<CCParameterListEntry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<CCParameterListEntry>();
            }
            return this.entry;
        }
