...
public class SnailEventListener implements StatementAwareUpdateListener {

	private static final Log logger = LogFactory.getLog(SnailEventListener.class);
	...
	public void update(EventBean[] arg0, EventBean[] arg1, EPStatement arg2,
		...
		if ((arg0 == null) || (ecspecMgmt.getSubscriptionsByLRName("Snail_1") == null))
			return;
		...
		for (String aSub : ecspecMgmt.getSubscriptionsByLRName("Snail_1")) {
			String host = aSub.split(":")[0];
			String port = aSub.split(":")[1];
			System.out.println("Sending Snail report to Cap App: " + host + ":" + port);
			try {
