 ...
 */
public class ObixSensorServerSocketSession extends AbstractServerSocketSensorSession {

	/** Logger for this class. */
	private static final Log logger = LogFactory.getLog(ObixSensorServerSocketSession.class);
	...
	public ObixSensorServerSocketSession(AbstractSensor<?> sensor, String ID,
	...
	protected MessageProcessingStrategyFactory getMessageProcessingStrategyFactory() {
		return new ObixMessageProcessingStrategyFactory(this);
	}
	 ...
	 * @author Matthew Dean - matt@pramari.com
	 */
	private class ObixMessageProcessingStrategyFactory implements
			MessageProcessingStrategyFactory {

		private ObixSensorServerSocketSession session = null;

		public ObixMessageProcessingStrategyFactory(
				ObixSensorServerSocketSession session) {
		...
		public MessageProcessingStrategy createMessageProcessor() {
			return new ObixMessageProcessingStrategy(session);
		}

	}

	/*
	 * Message processing strategy for the ObixSensorSession. This class will
	 ...
	 */
	private class ObixMessageProcessingStrategy implements
			MessageProcessingStrategy {

		private ObixSensorServerSocketSession session = null;

		public ObixMessageProcessingStrategy(ObixSensorServerSocketSession session) {
			this.session = session;
		}
