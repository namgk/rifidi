/*
 *  ObixSensorSessionTagHandler.java
 *
 *  Created:	Aug 4, 2010
 ...
 */
class ObixSensorSessionTagHandler {
	...
	public ObixSensorSessionTagHandler(String readerID) {

	}

	/** Logger for this class. */
	private static final Log logger = LogFactory
			.getLog(ObixSensorSessionTagHandler.class);
